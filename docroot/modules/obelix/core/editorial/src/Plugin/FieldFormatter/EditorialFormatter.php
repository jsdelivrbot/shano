...
/**
 * @file
 * Contains \Drupal\editorial\Plugin\Field\FieldFormatter\EditorialFormatter.
 */

namespace Drupal\editorial\Plugin\Field\FieldFormatter;
...
//            }
            ...
            \Drupal::moduleHandler()
              ->alter('editorial_field_entity_view', $entity, $item);
