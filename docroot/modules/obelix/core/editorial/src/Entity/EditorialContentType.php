...
/**
 * @file
 * Contains \Drupal\editorial\Entity\EditorialContentType.
 */

namespace Drupal\editorial\Entity;

use Drupal\Core\Config\Entity\ConfigEntityBundleBase;
use Drupal\editorial\EditorialContentTypeInterface;
 ...
 *   handlers = {
 *     "list_builder" = "Drupal\editorial\EditorialContentTypeListBuilder",
 *     "form" = {
 *       "add" = "Drupal\editorial\Form\EditorialContentTypeForm",
 *       "edit" = "Drupal\editorial\Form\EditorialContentTypeForm",
 *       "delete" = "Drupal\editorial\Form\EditorialContentTypeDeleteForm"
 *     },
 *     "route_provider" = {
 *       "html" = "Drupal\editorial\EditorialContentTypeHtmlRouteProvider",
 *     },
 *   },
