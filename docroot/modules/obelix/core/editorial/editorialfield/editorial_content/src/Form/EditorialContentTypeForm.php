...
/**
 * @file
 * Contains \Drupal\editorial_content\Form\EditorialContentTypeForm.
 */
 ...
 *
 * @package Drupal\editorial_content\Form
 */
class EditorialContentTypeForm extends EntityForm {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['id'] = array(
      ...
      '#machine_name' => array(
        'exists' => '\Drupal\editorial_content\Entity\EditorialContentType::load',
      ),
