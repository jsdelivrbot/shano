...
/**
 * @file
 * Contains Drupal\editorial_content\Controller\EditorialContentAddController.
 */

namespace Drupal\editorial_content\Controller;
 ...
 *
 * @package Drupal\editorial_content\Controller
 */
class EditorialContentAddController extends ControllerBase {
    ...
    public function add(Request $request) {
      ...
      if (count($types) === 0 && \Drupal::moduleHandler()->moduleExists('editorially_block_ui')) {
        return array(
